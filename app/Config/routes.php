...
Router::connect('/pages/conditions', array('controller' => 'pages', 'action' => 'display', 'conditions'));
Router::connect('/pages/readme', array('controller' => 'pages', 'action' => 'display', 'readme'));
